...
import 'package:royal_plate/set_items.dart';
                  ...
                  child: ListView(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Text('Your Favourites',
...
// To Search Item
  void _runFliter(String enteredKeyword){
    ...
    if(enteredKeyword.isEmpty){
      ...
      results = setlist.where((item) => item.SetFavouriteText.toLowerCase().contains(enteredKeyword.toLowerCase())).toList();
    }
